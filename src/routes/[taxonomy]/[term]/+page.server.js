...
import { get_posts, get_single_taxonomy, get_terms } from '@kucrut/wp-api-helpers';

/** @type {import('./$types').PageServerLoad} */
export async function load( { locals, params } ) {
	try {
		const terms = await get_terms( locals.wp_api_url, params.taxonomy, locals.wp_api_auth, 'view', {
			slug: [ params.term ],
		} );
